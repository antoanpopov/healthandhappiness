...
@section('pageTitle')
    {!! trans("dashboard::pages.cat-tools.edit",['entity' => $entity->name]) !!}
@endsection
...
@endsection
@section('breadcrumbs')
    {!! Breadcrumbs::render('admin.cat-tools.edit',$entity->name) !!}
@endsection
@section('content')
    {!! Form::open(['route' => ['admin.cat-tools.update',$entity], 'action' => 'POST']) !!}
