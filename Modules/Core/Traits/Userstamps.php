...
trait Userstamps
{
    ...
    {
        static::creating('Modules\Core\Listeners\Creating@handle');
        static::updating('Modules\Core\Listeners\Updating@handle');
        if (static::usingSoftDeletes()) {
            static::deleting('Modules\Core\Listeners\Deleting@handle');
            static::restoring('Modules\Core\Listeners\Restoring@handle');
        }
    }
