...
trait HasTags
{
    ...
    {
        return \Modules\Core\Entities\Tag\Tag::class;
    }
    ...
    /**
     * @param string|array|\ArrayAccess|\Modules\Core\Entities\Tag\Tag $tags
     */
     ...
     * @param array|\ArrayAccess|\Modules\Core\Entities\Tag\Tag $tags
     *
    ...
    /**
     * @param string|\Modules\Core\Entities\Tag\Tag $tag
     *
     * @return $this
     */
    ...
    public function detachTags($tags)
    {
        ...
        collect($tags)
            ->filter()
            ->each(function (\Modules\Core\Entities\Tag\Tag $tag) {
    ...
    protected static function convertToTags($values, $type = null, $locale = null)
    {
        return collect($values)->map(function ($value) use ($type, $locale) {
            if ($value instanceof \Modules\Core\Entities\Tag\Tag) {
