...
\Illuminate\Support\Facades\Route::get(str_slug(trans('frontend::pages.publications.detail')).'/{slug}', [
    'as' => 'publications.detail',
    'uses' => 'PublicationsController@detail',
]);

\Illuminate\Support\Facades\Route::get(str_slug(trans('frontend::pages.events.index')), [
    'as' => 'events.index',
    'uses' => 'EventsController@index',
]);

\Illuminate\Support\Facades\Route::get(str_slug(trans('frontend::pages.events.detail')).'/{slug}', [
    'as' => 'events.detail',
...
\Menu::make('main', function($menu){
    ...
    $menu->add(trans('frontend::pages.events.index'),     ['route'  => 'frontend.events.index']);
