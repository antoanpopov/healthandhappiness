...
$factory->define(\Modules\Frontend\Entities\Event::class, function (Faker $faker) {
    ...
    return [
        ...
        'start_date' => \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', date('Y-m-d H:i:s'))->addDays(rand(1,10)),
        'end_date' => \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', date('Y-m-d H:i:s'))->addDays(rand(10,12)),
